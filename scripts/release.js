...
console.log("current env:", envMode, process.env);
const pathName = "vite-vue2" + (envMode == "prod" ? "" : "-" + envMode);
const chinesName =
  envMode === "dev"
    ? "开发版"
    : envMode === "staging"
...
function init() {
  fetch("https://github.com/mingchangge/vite-vue2/latest.yml")
    .then((res) => {
